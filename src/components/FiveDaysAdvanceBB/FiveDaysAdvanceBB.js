...
import FiveDaysAdvanceBBTable from "./FiveDaysAdvanceBBTable";
import axios from "axios";
import Card from "../Card/Card";
import './FiveDaysAdvanceBB.css'

const FiveDaysAdvanceBB = (props) => {
  ...
  const getData = async () => {
    await axios
      .get("http://localhost:4200/fivedaysadvancebbs")
      .then((response) => {
...
export default FiveDaysAdvanceBB;
